...
public class FollowTwitterersJob implements Job {
	
	private Logger log = Logger.getLogger(FollowTwitterersJob.class.getName());
	
	public void execute(JobExecutionContext jec) throws JobExecutionException {
		log.info("Starting FollowTwitterersJob job...");
		...
		twitterService.followTwitterers(campaignName);
		log.info("Ended FollowTwitterersJob");
